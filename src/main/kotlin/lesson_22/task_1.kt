...
// а при сравнении объектов data class сравниваются сами объекты благодаря тому,что по умолчанию реализуется метод equals()
// , поэтому и результаты сравнения отличаются
